...
<head>
    ...
    <title>{% block title %}{{ title }} | {{ jazzmin_settings.site_title }} {% endblock content %}</title>
...
<body class="hold-transition{% if not jazzmin_settings.show_sidebar %} no-sidebar{% else %} sidebar-mini{% endif %} {% sidebar_status request %} {% if is_popup %}popup {% endif %}{% block bodyclass %} {% endblock content %} {{ jazzmin_ui.body_classes }} {% if jazzmin_ui.dark_mode_theme %}theme-dark{% endif %}" data-admin-utc-offset="{% now "Z" %}">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-auto d-flex flex-grow-1 align-items-center">
                            <h1 class="h4 m-0 pr-3 mr-3 border-right">{% block content_title %} {% endblock content %}</h1>
                            {% block breadcrumbs %} {% endblock content %}
                        </div>
                        {% block page_actions %} {% endblock content %}
                    </div>
                </div>
            </div>
            {% endif %}
...
{% block extrajs %} {% endblock content %}
