...
{% block bodyclass %}{{ block.super }} app-{{ opts.app_label }} model-{{ opts.model_name }} delete-confirmation {% endblock content %}
...
{% block content_title %} {% trans 'Delete' %}  {% endblock content %}
