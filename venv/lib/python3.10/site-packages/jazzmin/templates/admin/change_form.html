...
{% block content_title %} {{ opts.verbose_name_plural|capfirst }}  {% endblock content %}
...
{% block content %}
    ...
    <div id="content-main" class="col-12">
        <form {% if has_file_field %}enctype="multipart/form-data" {% endif %}action="{{ form_url }}" method="post" id="{{ opts.model_name }}_form" novalidate>
            {% csrf_token %}
            {% block form_top %} {% endblock content %}
            ...
            <div class="row">
                ...
                {% block inline_field_sets %} {% endblock content %}
                                    ...
                                    {% if not is_popup %}
                                        <div class="object-tools">
                                            {% block object-tools-items %}
                                                ...
                                                {% block extra_actions %} {% endblock content %}
                                             {% endblock content %}
                                        </div>
                                    {% endif %}
                                {% endif %}
