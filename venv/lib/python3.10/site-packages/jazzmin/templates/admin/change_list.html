...
{% block bodyclass %}{{ block.super }} app-{{ opts.app_label }} model-{{ opts.model_name }} change-list {% endblock content %}
...
{% block content_title %} {{ cl.opts.verbose_name_plural|capfirst }}  {% endblock content %}

{% block coltype %}flex {% endblock content %}
...
{% block content %}
    ...
    {% block date_hierarchy %}{% if cl.date_hierarchy %}{% date_hierarchy cl %}{% endif %} {% endblock content %}
        ...
        <div>
            <form id="changelist-form" method="post"{% if cl.formset and cl.formset.is_multipart %}enctype="multipart/form-data"{% endif %} novalidate>{% csrf_token %}
                <div id="content-main">
                    ...
                    <div class="row">
                        {% block pagination %}{% pagination cl %} {% endblock content %}
                    </div>
                </div>
                </div>
            </form>
