...
{% block coltype %}colSM {% endblock content %}
...
{% block title %}{% trans 'Template tags' %} {% endblock content %}
{% block content_title %}{% trans 'Template tag documentation' %} {% endblock content %}
